...
public class ComputeMaxPlayerScore {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			teamScores.print();
			teamScores.writeAsText("output/max_player_scores.txt", FileSystem.WriteMode.OVERWRITE).setParallelism(1);
			
			// Step 5: Trigger Execution
			JobExecutionResult result  =  env.execute("ComputeMaxPlayerScore");
