...
public class ComputeMinPlayerScore {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			teamScores.print();
			teamScores.writeAsText("output/min_player_scores.txt", FileSystem.WriteMode.OVERWRITE).setParallelism(1);
			
			// Step 5: Trigger Execution
			JobExecutionResult result  =  env.execute("ComputeMinPlayerScore");
