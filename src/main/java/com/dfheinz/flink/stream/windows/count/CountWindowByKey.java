...
public class CountWindowByKey {
	...
	public static void main(String[] args) throws Exception {
		...
		WindowedStream<EventBean,Tuple,GlobalWindow> windowedStream = dataStream
			.keyBy("key")
			.countWindow(4);
		DataStream<TireRobotOrder> robotOrders = windowedStream.apply(new TireRobotNotifyFunction());
	...
	public static class TireRobotNotifyFunction implements WindowFunction<EventBean, TireRobotOrder, Tuple,GlobalWindow>{
