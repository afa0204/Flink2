...
public class TumblingEventTimeWindowSize2 {
	...
	public static void main(String[] args) throws Exception {		
		...
		processedWindows.writeAsText("output/tumbling_event_time_windowsize2.txt",FileSystem.WriteMode.OVERWRITE).setParallelism(1);
