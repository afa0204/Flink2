...
public class TumblingEventTimeWithWatermarkWindowSize2 {
	...
	public static void main(String[] args) throws Exception {
		...
		DataStream<EventBean> eventStream = env
				...
				// .assignTimestampsAndWatermarks(new MyOutOfOrderTimestampAssigner(Time.seconds(6)));
		...
		processedWindows.writeAsText("output/tumbling_event_time_watermark_window2.txt",FileSystem.WriteMode.OVERWRITE).setParallelism(1);
	...
	private static class MyOutOfOrderTimestampAssigner extends BoundedOutOfOrdernessTimestampExtractor<EventBean> {
		public MyOutOfOrderTimestampAssigner(Time maxOutOfOrderness) {
